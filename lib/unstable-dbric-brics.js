      ...
      Dbric = (function() {
        ...
        class Dbric {
          ...
          _get_objects_in_build_statements() {
            ...
            var clasz, db_objects, error_count, i, len, match, message, name, ref, ref1, statement, statement_nr, type;
            clasz = this.constructor;
            db_objects = {};
            statement_nr = 0;
            error_count = 0;
          ...
          //-----------------------------------------------------------------------------------------------------
          _get_is_ready() {
            var error_count, expected_db_objects, expected_type, message, messages, name, present_db_objects, ref, type;
            ({
              error_count,
